...
public class RabbitMQConfig {
    ...
    public Exchange GOODS_UP_EXCHANG(){
    ...
    //队列与交换机绑定
    @Bean
    public Binding GOODS_UP_EXCHANG_BINDING(@Qualifier(SEARCH_ADD_QUEUE) Queue queue, @Qualifier(GOODS_UP_EXCHANGE) Exchange exchange) {
